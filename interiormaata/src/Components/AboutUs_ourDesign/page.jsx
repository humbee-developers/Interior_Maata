    ...
    <>
      ...
      <div className={styles.table_Section}>
        <div className={styles.table_content}>
          ...
          <Image className={styles.ourDesign_icons} src={Emphasis_logo} alt="image"  />
        ...
        <div className={styles.table_content}>
          <Image className={styles.ourDesign_icons}src={Variety_logo} alt="image" />
          <div className={styles.table_section_content}>
            <p className={styles.table_Section_emphasis}>Variety</p>
            <p className={styles.table_content_emphasis}>
              using different styles, colors, and textures for visual interest.
            </p>
          </div>
        </div>
        <div className={styles.table_content}>
          <Image className={styles.ourDesign_icons} src={Unity_logo} alt="image" />
          <div className={styles.table_section_content}>
        ...
        <div className={styles.table_content}>
          <Image className={styles.ourDesign_icons} src={Functionality_logo} alt="image" />
          <div className={styles.table_section_content}>
         ...
         <div className={styles.table_content}>
          <Image className={styles.ourDesign_icons} src={Materiality_logo} alt="image" />
          <div className={styles.table_section_content}>
