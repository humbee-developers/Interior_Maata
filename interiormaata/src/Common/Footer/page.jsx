      ...
      <div className={styles.Footer_Section}>
        <div className={styles.Footer_Content}>
          ...
          <div className={styles.footer_Second}>
            ...
            <ul className={styles.footerUl}>
              <li className={styles.footer_website}>
              others
              </li>
              <li className={styles.footer_home}>
        ...
        <div className={styles.footer_copyright}>
          ...
          <Image className={styles.footer_icons}  src={facebook_logo} alt="none" />
            {/* <p to="https://www.youtube.com/">sasas</p> */}
          </div>
          <div className={styles.footer_insta}>
          <Image className={styles.footer_icons} src={Instagram_logo} alt="none" />
            {/* <p>sasas</p> */}
          </div>
          <div className={styles.footer_youtube}>
            {/* <p>sasas</p> */}
            <Image className={styles.footer_icons} src={whatsapp_logo} alt="none" />
          </div>
          <div className={styles.footer_whatsapp}>
          <Image className={styles.footer_icons} src={youtube_logo} alt="none" />
            {/* <p>sasas</p> */}
          </div>
          <div className={styles.footer_linkedin}>
          <Image className={styles.footer_icons} src={linkedin_logo} alt="none" />
            {/* <p>sasas</p> */}
          </div>
        </div>
        </div>
